...
async def main() -> None:
    ...
    parser.add_argument("-i", "--input-file", type=pathlib.Path, help="input file path", dest="input_file")
    parser.add_argument("-o", "--output-dir", type=pathlib.Path, help="output to save files", dest="output_dir")
    args = cast(CLIArguments, parser.parse_args(sys.argv[1:]))
